...
from ..views import taglist, tagdetails, create_tag, CreateTag, DeleteTag, UpdateTag, TagList, TagDetails
...
urlpatterns = [
    ...
    url(r'^(?P<slug>[\w\-]+)/$', TagDetails.as_view(context_object_name = 'tag', template_name=("centralizer/tag_details.html"), model = Tag), name="centralizer_tagdetails"),
